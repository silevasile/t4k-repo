...
base='documentarys.do.am'
ADDON=xbmcaddon.Addon(id='plugin.video.RomyBuild')
...
def wizard(name,url,description):
    ...
    dp.create("plugin.video.RomyBuild","Se descarca! ",'', 'Sper sa va placa! :)')
