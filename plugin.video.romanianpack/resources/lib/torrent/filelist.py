...
class filelist:
    ...
    headers = [('Origin', 'https://' + base_url),
            ...
            ('Referer', 'https://' + base_url + '/'), ('X-Requested-With', 'XMLHttpRequest'), ('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8'), ('Accept-Language', 'ro,en-US;q=0.7,en;q=0.3'), ('Host', base_url)]
    ...
    def makeRequest(self, url, data={}, headers={}, raw=None):
        self.load_cookie()
    ...
    def login(self):
        ...
        headers = [('User-Agent', 'Mozilla/5.0 (Windows NT 6.1; rv:70.1) Gecko/20100101 Firefox/70.1'), ('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8'), ('Accept-Language', 'ro,en-US;q=0.7,en;q=0.3'), ('Host', base_url)]
        w = self.makeRequest('https://%s/login.php' % (base_url), headers=headers)
        ...
        headers = [('Origin', 'https://' + base_url),
            ...
            ('Referer', 'https://' + base_url + '/'), ('X-Requested-With', 'XMLHttpRequest'), ('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8'), ('Accept-Language', 'ro,en-US;q=0.7,en;q=0.3'), ('Host', base_url)]
        self.load_cookie()
        x = self.makeRequest('https://%s/takelogin.php' % (base_url), data=data, headers=headers, raw='1')
        if re.search('{"status":"OK"', x.read()):
